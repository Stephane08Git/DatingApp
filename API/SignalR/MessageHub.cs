...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDTo createMessageDTo)
        {
            ...
            var sender = await _userRepository.GetUserByUsermnameAsync(username);
            var recipient = await _userRepository.GetUserByUsermnameAsync(createMessageDTo.RecipientUsername);
